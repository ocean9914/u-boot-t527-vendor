...
#define AW_SPINAND_PHY_VER_SUB		0x17
#define AW_SPINAND_PHY_VER_DATE		0x20240115
...
#define SKYHIGH_UNLOCK_ALL_BLOCK_STEP1	0x7e
#define SKYHIGH_UNLOCK_ALL_BLOCK_STEP2	0x02
